...
class dataset_fly3d_train(dataset_sceneflow):
    ...
    def __init__(self, root):
        ...
        # get_paths_all
        self.str_filter = root + '/flyingthings3d/frames_finalpass_webp/TRAIN/*/*/left/*.webp'
...
class dataset_fly3d_test(dataset_sceneflow):
    ...
    def __init__(self, root):
        ...
        # get_paths_all
        self.str_filter = root + '/flyingthings3d/frames_finalpass_webp/TEST/*/*/left/*.webp'
        self.get_paths_all(self.str_filter, flag_sort=False)
...
class dataset_monkaa(dataset_sceneflow):
    ...
    def __init__(self, root):
        ...
        # get_paths_all
        self.str_filter = root + '/monkaa/frames_finalpass_webp/*/left/*.webp'
        self.get_paths_all(self.str_filter, flag_sort=False)
...
class dataset_driving(dataset_sceneflow):
    ...
    def __init__(self, root):
        ...
        # get_paths_all
        self.str_filter = root + '/driving/frames_finalpass_webp/*/*/*/left/*.webp'
        self.get_paths_all(self.str_filter, flag_sort=False)
...
class dataset_kitti_raw(dataset_kitti):
    ...
    def __init__(self, root):
        ...
        # get_paths_all
        self.str_filter = root + '/raw/*/*/image_02/data/*.png'
        self.get_paths_all(self.str_filter, flag_sort=False)
...
class dataset_kitti2015_train(dataset_kitti):
    ...
    def __init__(self, root):
        ...
        # get_paths_all
        self.str_filter = root + '/data_scene_flow/training/image_2/*_10.png'
...
class dataset_kitti2015_test(dataset_kitti):
    ...
    def __init__(self, root):
        ...
        # get_paths_all
        self.str_filter = root + '/data_scene_flow/testing/image_2/*_10.png'
        self.get_paths_all(self.str_filter, flag_sort=True)
...
class dataset_kitti2012_train(dataset_kitti):
    ...
    def __init__(self, root):
        ...
        # get_paths_all
        self.str_filter = root + '/data_stereo_flow/training/colored_0/*_10.png'
        self.get_paths_all(self.str_filter, flag_sort=True)
...
class dataset_kitti2012_test(dataset_kitti):
    ...
    def __init__(self, root):
        ...
        # get_paths_all
        self.str_filter = root + '/data_stereo_flow/testing/colored_0/*_10.png'
        self.get_paths_all(self.str_filter, flag_sort=True)
...
class dataset_middeval_train(dataset_middeval):
    ...
    def __init__(self, root):
        ...
        # get_paths_all
        self.str_filter = root + '/training*/*/im0.png'
        self.get_paths_all(self.str_filter, flag_sort=True)
...
class dataset_middeval_test(dataset_middeval):
    ...
    def __init__(self, root):
        ...
        # get_paths_all
        self.str_filter = root + '/test*/*/im0.png'
        self.get_paths_all(self.str_filter, flag_sort=True)
...
class dataset_eth3d_train(dataset_middeval):
    ...
    def __init__(self, root):
        ...
        # get_paths_all
        self.str_filter = root + '/two_view_training/*/im0.png'
        self.get_paths_all(self.str_filter, flag_sort=True)
...
class dataset_eth3d_test(dataset_middeval):
    ...
    def __init__(self, root):
        ...
        # get_paths_all
        self.str_filter = root + '/two_view_test/*/im0.png'
        self.get_paths_all(self.str_filter, flag_sort=True)
